"use strict";
def;
unflatten(flat_dict, dict[str, Any], sep, str = "|", inplace, bool = False) -  > dict[str, Any] | list[Any];
"";
";
Unflatten;
a;
    ...
    >>> unflatten({ "a|b|c": 1, "a|b|d": 2 });
{
    ...
    >>> unflatten({ "0": "a", "1": "b", "2": "c" })['a', 'b', 'c'];
"";
";
def;
_unflatten(data, dict) -  > dict | list;
result = {};
...
if (result)
    and;
all(isinstance(key, str), and, key.isdigit());
for (key in result)
    : return [result[str(i)]];
